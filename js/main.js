...
"Canadian Bacon", "Proscuitto", "Italian Sausage", "Ground Beef", "Anchovies",
"Turkey", "Ham", "Venison", "Lamb", "Duck", "Soylent Green", "Carne Asada",
"Soppressata Picante", "Coppa", "Pancetta", "Bresola", "Lox", "Guanciale",
"Chili", "Beef Jerky", "Pastrami", "Kielbasa", "Scallops", "Filet Mignon"]

pizzaIngredients.nonMeats = ["White Onions", "Red Onions", "Sauteed Onions",
"Green Peppers", "Red Peppers", "Banana Peppers", "Ghost Peppers", "Habanero Peppers",
"Jalapeno Peppers", "Stuffed Peppers", "Spinach", "Tomatoes", "Pineapple",
"Pear Slices", "Apple Slices", "Mushrooms", "Arugula", "Basil", "Fennel",
"Rosemary", "Cilantro", "Avocado", "Guacamole", "Salsa", "Swiss Chard", "Kale",
"Sun Dried Tomatoes", "Walnuts", "Artichoke", "Asparagus", "Caramelized Onions",
"Mango", "Garlic", "Olives", "Cauliflower", "Polenta", "Fried Egg", "Zucchini",
"Hummus"]
...
"Muenster Cheese", "Applewood Cheese", "Asiago Cheese", "Bleu Cheese", "Boursin Cheese",
"Brie Cheese", "Cheddar Cheese", "Chevre Cheese", "Havarti Cheese", "Jack Cheese",
"Pepper Jack Cheese", "Gruyere Cheese", "Limberger Cheese", "Manchego Cheese",
"Marscapone Cheese", "Pecorino Cheese", "Provolone Cheese", "Queso Cheese",
...
var ingredient = [pizzaIngredients.meats,pizzaIngredients.nonMeats,pizzaIngredients.cheeses,pizzaIngredients.sauces];
    ...
    resizePizzas = function(e) {
        ...
        function r(e) {
            ...
            for (var a = document.querySelectorAll(".randomPizzaContainer"), r = 0; r < a.length; r++) a[r].style.width = newWidth + "%"
        }
        window.performance.mark("mark_start_resize"), a(e), r(e), window.performance.mark("mark_end_resize"), window.performance.measure("measure_pizza_resize", "mark_start_resize", "mark_end_resize");
...
window.addEventListener("scroll", updatePositions), document.addEventListener("DOMContentLoaded", function() {
    for (var e = 8, a = 256, r = 0; 200 > r; r++) {
        ...
        n.className = "mover", n.src = "img/pizza.png", n.style.height = "100px", n.style.width = "73.333px", n.basicLeft = r % e * a, n.style.top = Math.floor(r / e) * a + "px", document.querySelector("#movingPizzas1").appendChild(n)
    }
    updatePositions()
});
